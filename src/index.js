  ...
  return (
    <Wrapper>
      <Helmet>
        ...
        <meta property='og:image:secure_url' content={`${copy.url}/opengraph.png`}/>
        ...
        {Object.keys(copy.baseUrl).map(key => (
          <link key={key} rel='alternate' hrefLang={key} href={copy.baseUrl[key]}/>
        ))}
      </Helmet>
